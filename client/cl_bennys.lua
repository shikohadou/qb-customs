...
CreateThread(function()
    for k, v in pairs(bennyGarages) do
        ...
        AddTextComponentString("Repairs")
            ...
            for k, v in pairs(bennyGarages) do
				...
				if nearDefault then
                    ...
                    bennyLocation = vector3(v.coords.x, v.coords.y, v.coords.z)
                     ...
                     if nearDefault then
                        if not isPlyInBennys then
                            Draw3DText(v.coords.x, v.coords.y, v.coords.z + 0.5, "[Press ~r~E~w~ For Vehicle Customization Menu]", 255, 255, 255, 255, 4, 0.45, true, true, true, true, 0, 0, 0, 0, 55)
